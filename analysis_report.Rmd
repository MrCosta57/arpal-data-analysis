...
The analysis is restricted to a period that goes from 2014-01-01 to 2023-12-31 and the original air quality data were hourly observations aggregated to daily using the mean and excluding NA values. More information can be found in the ARPALData library manual ^[https://cran.r-project.org/web/packages/ARPALData/index.html].
...
When the time series are plotted individually, their patterns become clearer. Each series exhibits variability and is evidently non-stationary, with indications of seasonal patterns across all stations.
